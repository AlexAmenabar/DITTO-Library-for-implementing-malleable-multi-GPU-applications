...
int main(int argc, char* argv[]){
    ...
    size_t maxN[3] = {(size_t)1048576 * (size_t)512 / (size_t)4, (size_t)1048576 * (size_t)1024 / (size_t)4, (size_t)1048576 * (size_t)2048 / (size_t)4}; // SMALL; MEDIAN; LARGE JOBS
    size_t T[4] = {1000, 2000, 3000, 4000}; // SMALL; MEDIAN; LARGE JOBS
    size_t K[5] = {50, 100, 250, 500, 1000}; // constant for all jobs types
    size_t goodGPUs[4] = {1, 2, 4, 8}; // SMALL; MEDIAN; LARGE JOBS (a different request is 'bad', underutilization or overutilization)
    size_t cpuK[4] = {1, 2, 4, 8}; // constant for all jobs types
    size_t P[2] = {1, 2};
